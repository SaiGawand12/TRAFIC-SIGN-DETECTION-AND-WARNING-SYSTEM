...
# camera_url = 'http://192.168.19.124:8080/video' #use external webcam(IP webcam)
# cap = cv2.VideoCapture(camera_url)

cap = cv2.VideoCapture(0) # use pc webcam(inbuilt) 
...
while cap.isOpened():
    ...
    if success:
        ...
        # red_light_index = 74
        # green_light_index = 75
        # yellow_light_index = 76
        ...
        for r in result:
            ...
            if r.boxes:
                ...
                # elif classes[red_light_index] in object_name:
                #     text47 ="\nWarning: Red  Signal!\n please stop!"
                #     #im_array = r.plot()  # plot a BGR numpy array of predictions
                #     cv2.putText(annotated_frame, text47, (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 0, 0), 2)
                # elif classes[green_light_index] in object_name:
                #     text48 ="\nWarning: green  Signal!\n please start!"
                #     #im_array = r.plot()  # plot a BGR numpy array of predictions
                #     cv2.putText(annotated_frame, text48, (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 0, 0), 2)
                # elif classes[yellow_light_index] in object_name:
                #     text49 ="\nWarning: yellow  Signal!\n Go!"
                #     #im_array = r.plot()  # plot a BGR numpy array of predictions
                #     cv2.putText(annotated_frame, text49, (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 0, 0), 2) 
                else:
                    print("No Detection!")
            # Display the annotated frame
